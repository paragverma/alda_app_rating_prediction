...
na_indices = np.where(dataset2["Translated_Review"].isna())
dataset2 = dataset2.drop(na_indices[0])
...
common_dataset = common_dataset.groupby(by="App", as_index=False).agg('first')